...
# ------------------------------- PLUE_episodic options -------------------------- #
_C.PLUE_episodic = CfgNode()
_C.PLUE_episodic.CTR= True
_C.PLUE_episodic.NUM_NEIGHBORS = 10
_C.PLUE_episodic.TEMPORAL_LENGTH = 5
_C.PLUE_episodic.TEMPERATURE = 0.07
_C.PLUE_episodic.LABEL_REFINEMENT = True
_C.PLUE_episodic.NEG_L = True
_C.PLUE_episodic.REWEIGHTING = True

############################################################################### ViDA parameters
_C.VIDA = CfgNode()
_C.VIDA.ViDALR = 5e-8
_C.VIDA.vida_rank1 = 1
_C.VIDA.vida_rank2 = 128
_C.VIDA.MT_ViDA = 0.999
_C.VIDA.MT = 0.999
_C.VIDA.WD = 0.0
_C.VIDA.ckpt = "/mnt/HDD2/HW_2/vida/imagenet/ckpt/imagent_vit_vida.pt"
###############################################################################
...
def get_num_classes(dataset_name):
    dataset_name2num_classes = {"cifar10": 10, "cifar10_c": 10, "cifar100": 100, "cifar100_c": 100,
                                ...
                                "domainnet126": 126, "office31": 31, "visda": 12, "officehome": 65, 'challenge': 200, 'challenge_test_debug': 200
                                }
